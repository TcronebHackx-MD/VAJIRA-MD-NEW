...
global.owner = process.env.OWNER_NUMBER  || 263716394979' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7QFxnL6B#1ix8GlzjWXJCQEpL-AQu0u5JdgMQ9bam8Owtstv3hog' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "263716394979,263716394979" : process.env.MODERATORS ,    
